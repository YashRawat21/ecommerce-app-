          ...
          <div className="categoryProducts">
            ...
            />
                ...
                {/* <div className="categorycategoryFilterItem">
                    ...
                    <div className="categoryInputItem">
                        <input type="checkbox" id="2" value = {2} onClick={() => filterItemByName("Skirts")}/>
                        <label className="categoryLabel" htmlFor="2">Skirts</label>
                    </div> 
                    <div className="categoryInputItem">
                        <input type="checkbox" id="3" value = {3} onClick={() => filterItemByName("Coats")}/>
                        <label className="categoryLabel" htmlFor="3">Coats</label>
                    </div>
                    <div className="categoryInputItem">
                        <input type="checkbox" id="4" value = {4} onClick={() => filterItemByName("Hat")}/>
