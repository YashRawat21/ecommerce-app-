...
const removeItem = (index) => {
  ...
  //Add To WishList
   ...
   //To Clear The Cart
    ...
    return(
        <SupplyContext.Provider value ={{cart, products,filters, setFilters,filteredItems, setCart,addToCart,wishList,addToWishList,removeItem,clearCart,removeWishlistItem ,selectedCurrency,currencyHandler,search,setSearch,searchHandler}}>
            {children}
